...
const panels = [
  {
    ...
    href: "/foam",
    image: "/images/divisions/foam-armchair.jpg",
  ...
  },
  {
    ...
    href: "/hometex",
    image: "/images/divisions/hometex-bed-linen.jpg",
  ...
  },
  {
    ...
    href: "/mattress",
    image: "/images/divisions/mattress-platform-bed.jpg",
  ...
  },
  {
    ...
    href: "/chemicals",
    image: "/images/divisions/chemicals-bench.jpg",
...
export default function DivisionPanels() {
  ...
  return (
    ...
    <section className="flex w-full flex-col bg-white md:h-[100svh] md:min-h-[42rem]">
      {/* One line, tight. The wall is the section; this is just a label on it,
          so it takes as little height as it can and still be read. */}
      <motion.div
        initial={reduceMotion ? false : rise.hidden}
        whileInView={rise.show}
        viewport={VIEWPORT}
        className="shell flex flex-col gap-2 pb-6 pt-10 md:flex-row md:items-baseline md:justify-between md:gap-8 md:pb-7"
      >
        <h2 className="display text-[1.35rem] font-light leading-tight tracking-[-0.01em] text-ink sm:text-[1.7rem]">
          From the foam inside a sofa
          <span className="font-bold"> to the sheet on the bed</span>
        </h2>

        <span className="flex shrink-0 items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.28em] text-brand">
