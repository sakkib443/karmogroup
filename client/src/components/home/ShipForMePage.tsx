...
import {
    LuPackage, LuMapPin, LuCircleCheck, LuTruck, LuHouse,
    LuPlay, LuArrowRight, LuGlobe, LuHeadphones,
    LuChartColumn, LuShield, LuDollarSign,
} from 'react-icons/lu';
...
/* ── Why choose features ── */
const features = [
    { icon: <LuShield size={28} />, title: 'Seamless Integration', desc: 'Effortlessly manage your shipments with our user-friendly platform.' },
    { icon: <LuChartColumn size={28} />, title: 'Real-Time Tracking', desc: 'Monitor your shipment status from dispatch to delivery.' },
    { icon: <LuDollarSign size={28} />, title: 'Cost-Effective Solutions', desc: 'Enjoy competitive shipping rates and save on logistics costs.' },
    { icon: <LuGlobe size={28} />, title: 'Global Reach', desc: 'Connect with suppliers and ship products from multiple countries.' },
    { icon: <LuHeadphones size={28} />, title: 'Customer Support', desc: 'Get dedicated support to handle your queries & ensure smooth operations.' },
];
                            ...
                            <ul className="space-y-3 mb-5">
                                {stepDetails[activeStep].bullets.map((b, i) => (
                                    <li key={i} className="flex gap-2 text-sm text-gray-600">
                                        <span className="mt-0.5 text-[var(--color-primary)] flex-shrink-0"><LuCircleCheck size={16} /></span>
