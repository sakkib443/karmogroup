  ...
  return (
    ...
    >
      ...
      <div className={flipped ? "lg:order-1" : ""}>
        {/* The shared heading, unnumbered — this row sits outside the 01-04
            run. It was its own markup at its own size until the page was
            pulled onto one treatment. */}
        <SectionHeading
          eyebrow={item.tag}
          title={[item.title, <Accent key="a">{item.titleAccent}</Accent>]}
          lead={item.lead}
