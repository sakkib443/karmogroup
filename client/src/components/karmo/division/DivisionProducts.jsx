...
export default function DivisionProducts({
  ...
  return (
    <section
      id={offersId}
      className="relative scroll-mt-[7.5rem] overflow-hidden bg-white pb-16 pt-4 lg:pb-24 lg:pt-6"
    >
      {textured ? (
      ...
      {list.length === 0 ? (
        ...
        <motion.div
          ...
          className={
            catalogue
              ? "relative z-[1] mx-auto grid w-full max-w-[1520px] grid-cols-1 items-stretch gap-5 px-5 sm:grid-cols-2 sm:gap-6 md:px-8 lg:grid-cols-3 lg:gap-6 lg:px-10"
